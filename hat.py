...
def add_hat(img,hat_img):
    ...
    predictor_path = "E:\monkeyrunner\image\shape_predictor_5_face_landmarks.dat"
...
# 读取头像图
img = cv2.imread("E:/monkeyrunner/image/all.jpg")
# img = cv2.imread("E:/monkeyrunner/image/nkw.jpg")
...
cv2.imwrite("E:/monkeyrunner/image/add_hat_all.jpg",output)
...
os.startfile("E:\monkeyrunner\image")
